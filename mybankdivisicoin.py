...
class Bank:
    ...
    def validate_tx(self, tx):
        ...
        for tx_in in tx.tx_ins:
            ...
            spendable_tx_out = self.txns[tx_in.tx_id].tx_outs[tx_in.index]
            public_key = spendable_tx_out.public_key
            public_key.verify(tx_in.signature, tx_in.spend_message())

            in_sum += spendable_tx_out.amount
    ...
    def fetch_utxo(self, public_key):
        ...
        return [tx_out for tx in self.txns.values()
